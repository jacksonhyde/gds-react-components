...
export type GovUKLogoNavProps = AsElementLink<HTMLAnchorElement>

const SVGImageWithSrc: React.FC<SVGImageWithSrc> = (props) => <image {...props} />;

const GovUKLogo: React.FC<GovUKLogoNavProps> = ({
  className,
  alt,
  ...
  return (
    <div className='govuk-header__logo'>
      ...
      >
        ...
        {serviceName ? <span className="govuk-header__link govuk-header__link--service-name">{serviceName}</span> : null}
      </Component>
    </div>
  );
};

GovUKLogo.defaultProps = {
