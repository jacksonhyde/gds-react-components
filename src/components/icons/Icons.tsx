...
export const BaseIconSVG: React.FC<BaseIconSVGProps> = ({
  ...
  <svg
    className={classNames('govuk-icon', iconType, className)}
...
export const ArrowLeft: React.FC<BaseIconSVGProps> = (props) => (
  <BaseIconSVG iconType="govuk-icon__arrow-left" {...props}>
...
export const ArrowRight: React.FC<BaseIconSVGProps> = (props) => (
  <BaseIconSVG iconType="govuk-icon__arrow-right" {...props}>
...
export const ArrowRightCircle: React.FC<BaseIconSVGProps> = (props) => (
  <BaseIconSVG iconType="govuk-icon__arrow-right-circle" {...props}>
...
export const ChevronLeft: React.FC<BaseIconSVGProps> = (props) => (
  <BaseIconSVG iconType="govuk-icon__chevron-left" {...props}>
...
export const ChevronRight: React.FC<BaseIconSVGProps> = (props) => (
  <BaseIconSVG iconType="govuk-icon__chevron-right" {...props}>
    <path d="M15.5 12a1 1 0 0 1-.29.71l-5 5a1 1 0 0 1-1.42-1.42l4.3-4.29-4.3-4.29a1 1 0 0 1 1.42-1.42l5 5a1 1 0 0 1 .29.71z" />
  </BaseIconSVG>
);

export const Close: React.FC<BaseIconSVGProps> = (props) => (
  <BaseIconSVG iconType="govuk-icon__close" {...props}>
...
export const Cross: React.FC<BaseIconSVGProps> = (props) => (
  <BaseIconSVG iconType="govuk-icon__cross" {...props}>
...
export const SmallEmdash: React.FC<BaseIconSVGProps> = ({ height, width, ...rest }) => (
  <BaseIconSVG iconType="govuk-icon__emdash" height={height || 1} width={width || 16} {...rest}>
    <path d="M0 0h16v1H0z" />
  </BaseIconSVG>
);

export const Emdash: React.FC<BaseIconSVGProps> = ({ height, width, ...rest }) => (
  <BaseIconSVG iconType="govuk-icon__emdash" height={height || 1} width={width || 19} {...rest}>
    <path d="M0 0h19v1H0z" />
  </BaseIconSVG>
);

export const Minus: React.FC<BaseIconSVGProps> = (props) => (
  <BaseIconSVG iconType="govuk-icon__minus" {...props}>
...
export const Search: React.FC<BaseIconSVGProps> = (props) => (
  <BaseIconSVG iconType="govuk-icon__search" {...props}>
    <path d="M19.71 18.29l-4.11-4.1a7 7 0 1 0-1.41 1.41l4.1 4.11a1 1 0 0 0 1.42 0 1 1 0 0 0 0-1.42zM5 10a5 5 0 1 1 5 5 5 5 0 0 1-5-5z" />
  </BaseIconSVG>
);

export const Tick: React.FC<BaseIconSVGProps> = (props) => (
  <BaseIconSVG iconType="govuk-icon__tick" {...props}>
    <path
      strokeWidth="4"
      strokeLinecap="round"
      stroke="#007f3b"
